...
<div class="main-content">
    ...
    <form action="<?php echo e(route('users.updateUser', $user->id)); ?>" method="POST" class="mt-4">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" name="account_type"
                   ...
                   value="<?php echo e(old('account_type', $user->account_type)); ?>" required>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" name="user_id"
                   style="background-color: #1e1e1e; border: 1px solid #f8a5c2; color: #fce4ec;"
                   value="<?php echo e(old('user_id', $user->user_id)); ?>" required>
        </div>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\pjbe2new\srcDoAn\resources\views/crud_user/UserAdminEdit.blade.php ENDPATH**/ ?>